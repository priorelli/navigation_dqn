...
def main():
    ...
    for episode in range(episodes):
        ...
        while not done and step < steps:
            ...
            with tf.GradientTape() as g:
                ...
                target_q = q_target.feedforward(state_new)
                target = tf.cast(gamma * np.max(target_q), tf.float32)
    ...
    # save objects
    pickle.dump(rewards_variation, open('results/reward_variation_dqn_double.pkl', 'wb'))
    pickle.dump(steps_variation, open('results/steps_variation_dqn_double.pkl', 'wb'))
    pickle.dump(scores, open('results/scores_dqn_double.pkl', 'wb'))
    pickle.dump(losses, open('results/losses_dqn_double.pkl', 'wb'))
