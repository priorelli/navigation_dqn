...
def main():
        ...
        while not done and step < steps:
            ...
            if batch == max_batch - 1 or batch == steps - 1:
                ...
                with tf.GradientTape() as g:
                    ...
                    targets_q = tf.convert_to_tensor([q_primary.feedforward(i[1])[0] for i in experience])
    ...
    # save objects
    pickle.dump(rewards_variation, open('results/reward_variation_dqn_exp.pkl', 'wb'))
    pickle.dump(steps_variation, open('results/steps_variation_dqn_exp.pkl', 'wb'))
    pickle.dump(scores, open('results/scores_dqn_exp.pkl', 'wb'))
    pickle.dump(losses, open('results/losses_dqn_exp.pkl', 'wb'))
