...
def main():
    ...
    for episode in range(episodes):
        ...
        while not done and step < steps:
            ...
            with tf.GradientTape() as g:
                ...
                target_q = q_primary.feedforward(state_new)
    ...
    # save objects
    pickle.dump(rewards_variation, open('results/rewards_variation_dqn.pkl', 'wb'))
    pickle.dump(steps_variation, open('results/steps_variation_dqn.pkl', 'wb'))
    pickle.dump(scores, open('results/scores_dqn.pkl', 'wb'))
    pickle.dump(losses, open('results/losses_dqn.pkl', 'wb'))
